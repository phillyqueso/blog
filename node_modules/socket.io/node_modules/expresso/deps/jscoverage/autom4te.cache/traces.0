...
aclocal.m4:672: _AM_SET_OPTIONS is expanded from...
...
@%:@undef HAVE_ASPRINTF])
m4trace:configure.ac:45: -1- AC_DEFINE_TRACE_LITERAL([HAVE_MULTIBYTETOWIDECHAR])
m4trace:configure.ac:45: -1- m4_pattern_allow([^HAVE_MULTIBYTETOWIDECHAR$])
m4trace:configure.ac:45: -1- AH_OUTPUT([HAVE_MULTIBYTETOWIDECHAR], [/* Define to 1 if you have the `MultiByteToWideChar\' function. */
